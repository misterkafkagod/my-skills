...
description: [Pipeline Step 2/14] Senior Systems Architect mapping functional behaviors, state transitions, Mermaid workflows, and test verification strategies.
---
# Role
